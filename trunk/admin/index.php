...
include_once ICMS_ROOT_PATH.'/modules/isearch/admin/functions.php';
include_once ICMS_ROOT_PATH.'/modules/isearch/include/functions.php';


if (file_exists(ICMS_ROOT_PATH.'/modules/isearch/language/' . $xoopsConfig['language'] . '/main.php')) {
	include_once ICMS_ROOT_PATH.'/modules/isearch/language/' . $xoopsConfig['language'] . '/main.php';
} else {
	include_once ICMS_ROOT_PATH.'/modules/isearch/language/english/main.php';
}
...
switch ($op) {
	...
	case 'purge':
        ...
        isearch_adminmenu(1);
        echo '<br />';
		$sform = new XoopsThemeForm(_AM_ISEARCH_PRUNE, 'pruneform', ICMS_URL.'/modules/isearch/admin/index.php', 'post');
	...
	case 'export':
		...
		$sform = new XoopsThemeForm(_AM_ISEARCH_EXPORT, 'exportform', ICMS_URL.'/modules/isearch/admin/index.php', 'post');
	...
	case 'SearchExport':
		...
		$searchfile=ICMS_ROOT_PATH.'/uploads/isearch_keywords.txt';
		$searchfile2 =ICMS_URL.'/uploads/isearch_keywords.txt';
		$tbl=array();
		...
		if(count($tbl)>0) {
			...
			fclose($fp);
			printf(_AM_ISEARCH_EXPORT_READY,$searchfile2,ICMS_URL.'/modules/isearch/admin/index.php?op=deletefile');
		} else {
	...
	case 'deletefile':
		xoops_cp_header();
		$statfile=ICMS_ROOT_PATH.'/uploads/isearch_keywords.txt';
		if(unlink($statfile)) {
	...
	case 'blacklist':
		...
		isearch_adminmenu(3);
		include_once ICMS_ROOT_PATH.'/class/xoopsformloader.php';
		include_once ICMS_ROOT_PATH.'/modules/isearch/class/blacklist.php';
		echo '<h3>'._AM_ISEARCH_BLACKLIST.'</h3>';
		$sform = new XoopsThemeForm(_AM_ISEARCH_BLACKLIST, 'MetagenBlackList', ICMS_URL.'/modules/isearch/admin/index.php', 'post');
	...
	default:
		...
		echo "<img onclick=\"toggle('toptable'); toggleIcon('toptableicon');\" id='keywordscounticon' name='keywordscounticon' src=" . ICMS_URL . "/modules/isearch/images/close12.gif alt='' /></a>&nbsp;"._AM_ISEARCH_KEYWORDS."</h4>";
		...
		foreach($elements as $oneelement) {
			...
			$link1 = "<a href='".ICMS_URL.'/search.php?query='.$oneelement->getVar('keyword')."&action=results' target='_blank'>".$oneelement->getVar('keyword')."</a>";
			$link2 = "<a href='".ICMS_URL."/userinfo.php?uid=".$oneelement->getVar('uid')."'>".$oneelement->uname()."</a>";
		...
		echo "<img onclick=\"toggle('toptable'); toggleIcon('toptableicon');\" id='mostsearchicon' name='mostsearchicon' src=" . ICMS_URL . "/modules/isearch/images/close12.gif alt='' /></a>&nbsp;"._AM_ISEARCH_MOST_SEARCH."</h4>";
		...
		foreach($elements as $onekeyword_id => $onekeyword_datas) {
			...
			$class = ($class == 'even') ? 'odd' : 'even';
			$link1 = "<a href='".ICMS_URL.'/search.php?query='.$onekeyword."&action=results' target='_blank'>".$onekeyword."</a>";
		...
		echo "<img onclick=\"toggle('toptable'); toggleIcon('toptableicon');\" id='bigcontributicon' name='bigcontributicon' src=" . ICMS_URL . "/modules/isearch/images/close12.gif alt='' /></a>&nbsp;"._AM_ISEARCH_BIGGEST_USERS."</h4>";
		...
		foreach($elements as $oneuser => $onecount) {
			$class = ($class == 'even') ? 'odd' : 'even';
			$link1 = "<a href='".ICMS_URL."/userinfo.php?uid=".$oneuser."'>".$tmpisearch->uname($oneuser)."</a>";
		...
		echo "<img onclick=\"toggle('toptable'); toggleIcon('toptableicon');\" id='daystaticon' name='daystaticon' src=" . ICMS_URL . "/modules/isearch/images/close12.gif alt='' /></a>&nbsp;"._AM_ISEARCH_DAY_STATS."</h4>";
		echo "<div id='daystat'>";
		echo '<br />';
		echo "<table width='100%' cellspacing='1' cellpadding='3' border='0' class='outer'>";
		...
		echo "<img onclick=\"toggle('toptable'); toggleIcon('toptableicon');\" id='ipcounticon' name='ipcounticon' src=" . ICMS_URL . "/modules/isearch/images/close12.gif alt='' /></a>&nbsp;"._AM_ISEARCH_IP."</h4>";
		echo "<div id='ipcount'>";
		echo '<br />';
		echo "<table width='100%' cellspacing='1' cellpadding='3' border='0' class='outer'>";
